...
#define MAX96724_I2C_P0_LINK_A_SLAVE_ADDR	0x0640
#define MAX96724_I2C_P0_LINK_A_MASTER_ADDR	0x0641
#define MAX96724_I2C_LINK_STRIDE			0x0010
#define MAX96724_I2C_P0_SLAVE_ADDR(link) \
	(MAX96724_I2C_P0_LINK_A_SLAVE_ADDR + \
...
#define MAX96724_I2C_FAST_PLUS_SLAVE_VAL	0x09
#define MAX96724_I2C_FAST_PLUS_MASTER_VAL	0x71
...
int max96724_init_settings(struct device *dev)
{
	...
	/*
	 * Raise the port-0 I2C master on every link to Fast-mode Plus
	 * (980 kbps): SLV_SH=0b00/SLV_TO=0b001 and
	 * MST_BT=0b111/MST_TO=0b001.
	 */
	struct reg_pair i2c_fast_plus[] = {
		{MAX96724_I2C_P0_SLAVE_ADDR(0),
		 MAX96724_I2C_FAST_PLUS_SLAVE_VAL},
		{MAX96724_I2C_P0_MASTER_ADDR(0),
		 MAX96724_I2C_FAST_PLUS_MASTER_VAL},
		{MAX96724_I2C_P0_SLAVE_ADDR(1),
		 MAX96724_I2C_FAST_PLUS_SLAVE_VAL},
		{MAX96724_I2C_P0_MASTER_ADDR(1),
		 MAX96724_I2C_FAST_PLUS_MASTER_VAL},
		{MAX96724_I2C_P0_SLAVE_ADDR(2),
		 MAX96724_I2C_FAST_PLUS_SLAVE_VAL},
		{MAX96724_I2C_P0_MASTER_ADDR(2),
		 MAX96724_I2C_FAST_PLUS_MASTER_VAL},
		{MAX96724_I2C_P0_SLAVE_ADDR(3),
		 MAX96724_I2C_FAST_PLUS_SLAVE_VAL},
		{MAX96724_I2C_P0_MASTER_ADDR(3),
		 MAX96724_I2C_FAST_PLUS_MASTER_VAL},
	};

	mutex_lock(&priv->lock);

	err |= max96724_set_registers(dev, i2c_fast_plus,
