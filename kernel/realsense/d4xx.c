 ...
 * reuses the IR control bank to request four 30-FPS members through one
 * aggregate GMSL node while the final PerceptionSetConfig ABI is reviewed. */
static const u16 d58x_perception_poc_framerates[] = {120};
